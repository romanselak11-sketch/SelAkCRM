...
from selakcrm.routes import analytics_audit_routes, auth_routes, clients_routes, health_setup, home_routes, insurance_routes, me_routes, policies_routes, users_routes
